...
YAML_INPUTS <- yaml::read_yaml(args[1]) # "config/bin_class/non-centered.yaml"
...
W_gamma_scale[[2]] <- fbm_gamma_params_to_stan(FBM_W$GAMMA_WIDTH[[2]], FBM_W$GAMMA_ALPHA[[2]], 15)$STAN_BETA
...
df <- data.frame(read.table("./data/bdata", header = FALSE))
