...
# python_path <- "numpyro_c_2021_05_28_12_47_20" #  numpyro_nc_2021_03_19_11_33_38 numpyro_c_2021_03_21_15_46_28
python_path <- "numpyro_rmhmc_2021_06_30_21_22_02"
...
fbm <- read_rds(str_c("./output/1d_reg/", fbm_path, "/outputs.rds"))
...
plot_traces <- function(df, title, subtext, size = 0.15, thin = T, log = FALSE){
  ...
  df_plot <- bind_rows(df %>% filter(t %in% keep_iters, !str_detect(method, "rmhmc")), 
                  df %>% filter(str_detect(method, "rmhmc")))
