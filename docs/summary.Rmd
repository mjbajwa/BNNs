...
- tanh activation 
- _parameter groups_: input-hidden weights, output-hidden weights, hidden biases, output bias
...
# Experiment 2 (Less Vague Priors)
...
# Experiment 3 (Less Vague Priors)
